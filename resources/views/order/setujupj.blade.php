...
<div style="margin-left: auto; margin-right: auto;">
   ...
   <div class="row text-center" id="keranjang13" style="margin-left: auto; margin-right: auto;">
     <div class="card card-profile shadow " style="width: 100%;">
        ...
        <form method="post" action="{{url('order/pppj')}}">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="form-group" style="margin-left : 10px;">
                                                  <select class="form-control" name="setujub[{{$pj['idp']}}]">
                                                        ...
                                                        <option @if($pj['sdosen'] == 0) selected @endif value="0">Setujui Nanti</option>
                                                  </select>  
                                                </div>
                                                @endif
                                            </div>
            ...
            <div class="col-lg-12 " style="margin-bottom:10px; ">
                <div class="card rounded">
                    <div style="margin-left: 1px;" class="row rounded-top" >  
                        ...
                        <textarea id="txta" style="max-width:100%;" class="form-control" name="pesan" rows="3">{{$orderku[0]->noteDosen}}</textarea>
                    </div>
                </div>
            </div>        
        </div>
 ...
 @if(isMobile())                
        <form  method="post" action="{{url('order/pppj')}}">
            @csrf
            <input type="hidden" name="pesan" id="txtc"  value="{{$orderku[0]->noteDosen}}">
