                  ...
                  <div id="a{{$item['id']}}" class="col-lg-12 overflow-auto" style="margin-bottom:10px; min-width: 100px; ">
                        <div class="card" style=" min-width: 100px;">
                            ...
                            <div style="text-align:left; padding:0px 10px 0px 10px;">
                                <h5>{{$item['barang']}}<br>{{$v['kat']}}<br><br>{{$item['lab']}}<br>{{$item['fakultas']}}</h5>
                            </div>
                            ...
                            <div style="margin-top: auto; margin-bottom: auto;  text-align:left; min-width: 200px;  ">
                                <div style="padding:10px;">
                                    ...
                                    <div class="btn-group" role="group" style="margin-bottom:5px;" id="b{{str_pad($hitung,4,'0',STR_PAD_LEFT).$item['id']}}">
                                        ...
                                        <div class="">
                                            ...
                                            <div class="col" id="b{{str_pad($hitung,4,'0',STR_PAD_LEFT).$item['id']}}">
                                                <div class="btn-group" role="group" style="margin-bottom:5px;">
                                                    ...
                                                    <button onclick="delete1('b{{str_pad($hitung,4,'0',STR_PAD_LEFT).$item['id']}}','a{{$item['id']}}');" id="b{{$hitung.$item['id']}}" class="btn btn-danger" style=" margin-left:5px;"><i class="icofont-ui-delete"></i> Hapus</button><br>
                                                </div>  
                                            </div>
                                            <?php $hitung++; ?>
                                            @endforeach 
                    ...
                    @endif
                          ...
                          <button style="width: 100%; margin-top: 10px;" id="checkout" class="btn btn-fik" >Checkout</button>
    ...
    <div class="container-fluid">
        ...
        <ul class="navbar-nav align-items-center d-none d-md-flex">
            ...
            <li class="nav-item dropdown">
                <button type="button" class="btn btn-fik" data-toggle="dropdown" id="buka3">
            ...
            <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <div class="media align-items-center">
                    <span class="avatar avatar-sm rounded-circle">
                        <img alt=""  src="https://my.ubaya.ac.id/img/mhs/{{auth()->user()->nrpnpk}}_m.jpg">
                    </span>
