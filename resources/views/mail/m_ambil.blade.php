									...
									<tr>
										<td>
											<table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #000000; color: #333;" width="80%">
												<tbody>
													<tr>
														<th class="column" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; vertical-align: top; padding-top: 0px; padding-bottom: 0px;" width="33%">
														...
														<th class="column" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; vertical-align: top; padding-top: 0px; padding-bottom: 0px;" width="34%">
															<table border="0" cellpadding="10" cellspacing="0" class="text_block" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;" width="50%">
																<tr>
																	<td>
																		<div style="font-family: Tahoma, Verdana, sans-serif">
																			<div style="font-size: 12px; font-family: 'Lato', Tahoma, Verdana, Segoe, sans-serif; color: #555555; line-height: 1.2;">
																				<p style="margin: 0; font-size: 12px;"><span style="font-size:18px;color:#ffffff;"><strong>KALAB / LABORAN</strong></span></p>
																			</div>
																		</div>
																	</td>
																</tr>
									...
									<tr>
										<td>
											<table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content stack" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="80%">
												<tbody>
													<tr>
														<th class="column" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; vertical-align: top; padding-top: 5px; padding-bottom: 5px;" width="33%">
															<table border="0" cellpadding="0" cellspacing="0" class="text_block" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;" width="100%">
																<tr>
														...
														<th class="column" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; vertical-align: top; padding-top: 5px; padding-bottom: 5px;" width="34%">
															<table border="0" cellpadding="0" cellspacing="0" class="text_block" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;" width="100%">
																<tr>
																	<td style="padding-bottom:10px;padding-left:20px;padding-right:20px;padding-top:10px;">
																		<div style="font-family: sans-serif">
																			<div style="font-size: 12px; color: #000000; line-height: 1.2; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif;">
																				<p style="margin: 0; font-size: 14px;"><span style="color:#000000;font-size:14px;"><a href="https://beefree.io" rel="noopener" style="text-decoration:none;color:#000000;" target="_blank"></a><span style="font-size:24px;"><strong>{{$kalab[0]->nrpnpk}} </strong></span></span></p>
																				<p style="margin: 0; font-size: 14px;"><span style="color:#000000;font-size:14px;"><span style="font-size:24px;"><strong>{{$kalab[0]->nama}}</strong></span></span></p>
																				<p style="margin: 0; font-size: 14px;"><span style="color:#000000;font-size:14px;">{{$kalab[0]->email}}</span></p>
																				<p style="margin: 0; font-size: 14px;"><span style="color:#000000;font-size:14px;">{{$kalab[0]->notelp}} - {{$kalab[0]->lineId}}</span></p>
																			</div>
																		</div>
																	</td>
																</tr>
																		...
																		<td>
																			<div style="font-family: Tahoma, Verdana, sans-serif">
																				<div style="font-size: 12px; color: #555555; line-height: 1.2; font-family: 'Lato', Tahoma, Verdana, Segoe, sans-serif;">
																					<p style="margin: 0; font-size: 12px;"><span style="color:#ffffff;"><span style="font-size:18px;"><strong>CATATAN KHUSUS</strong></span></span></p>
																				</div>
																			</div>
																		</td>
																	</tr>
																		...
																		<td style="padding-bottom:10px;padding-left:20px;padding-right:20px;padding-top:10px;">
																			<div style="font-family: sans-serif">
																				<div style="font-size: 12px; color: #000000; line-height: 1.2; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif;">
																					...
																					<p style="margin: 0; font-size: 14px;"><span style="color:#000000;font-size:12px;"><span style="font-size:14px;">
																						@if($ambil[0]->note == "") Tidak Ada Catatan @else {{$ambil[0]->note}} @endif</span></span></p>
