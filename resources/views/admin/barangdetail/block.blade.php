    ...
    <div class="row">
        <div class="col-xl-12 mb-5 mb-xl-0">
            ...
            <div class="card bg-secondary shadow">
                ...
                <form enctype="multipart/form-data" role="form" method="POST" action="{{route('barangdetail.storeblock')}}">
                    @csrf
                    ...
                    <div class="pl-lg-4">
                        <div class="form-group">
                            <label>Tanggal</label>
                            <input class="form-control form-control-alternative" type="date" name="dateTanggal" id= "dateTanggal" min="{{ now()->toDateString('Y-m-d') }}">
                        </div>
                        <div class="form-group">
						...
						<button onclick="inputblock()" type="button" class="btn btn-warning">Tambah Block Penggunaan</button>
...
<script>
	...
	function inputblock() {
		...
		if (!tersedia) {
			sesi.push([tanggal,IDsesi,mulai, selesai,idBarangdetail,keterangan]);
		}

		$.ajax({
			type: 'POST',
			url: '{{route("barangdetail.showblock")}}',
			data: {
